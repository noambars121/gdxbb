      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
        ...
        >
          <div className="flex flex-col">
            <span className="font-sans font-bold text-lg sm:text-xl tracking-tight text-white group-hover:text-brand-accent transition-colors whitespace-nowrap">
              <span className="sm:hidden">
                GD <span className="text-brand-accent font-light">×</span> BB
              </span>
              <span className="hidden sm:inline">
                Gemini Digital <span className="text-brand-accent font-light">×</span> BarsBuild
              </span>
            </span>
            <span className="hidden sm:block text-xs text-slate-400 font-hebrew">
              {SITE_CONFIG.categoryLabel}
            </span>
          </div>
        </a>

        {/* Minimal 3-item navigation: איך זה עובד | פרויקטים | דברו איתנו */}
