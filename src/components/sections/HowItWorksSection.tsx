  ...
  const steps = [
    {
      num: '01',
      icon: MessageSquare,
      title: 'אפיון ושיחת מטרות',
      description:
        'הבנת הקהל שלכם, ניתוח המתחרים והגדרת מטרות ההמרה של האתר ללא סרבול מיותר.',
    },
    {
      num: '02',
      icon: LayoutTemplate,
      title: 'ארכיטקטורה ועיצוב UX',
      description:
        'בניית סדר פסיכולוגי, קופיקראפטינג עברי מדויק ושפה ויזואלית יוקרתית המותאמת למותג.',
    },
    {
      num: '03',
      icon: Terminal,
      title: 'פיתוח קוד מהיר וביצועים',
      description:
        'כתיבת קוד סטטי נקי ב-Next.js, בדיקות מהירות ואבטחת נגישות מקסימלית.',
    },
    {
      num: '04',
      icon: Rocket,
      ...
      description:
        'העלאה לשרת מבוזר, חיבור WhatsApp עסקי והתחלת קבלת פניות ישירות מהיום הראשון.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-400 text-base sm:text-lg">
            תהליך עבודה מובנה ב-4 שלבים שנועד להביא את האתר שלכם לאוויר בתוך זמן קצר.
          </p>
        </div>
